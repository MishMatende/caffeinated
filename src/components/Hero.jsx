  ...
  return (
    <>
      <h1>
        ...
        <abbr title="An enthusist or devotee">Fiends</abbr>
      </h1>
      <div className="benefits-list">
        <h3 className="font-bolder">
          Try <span className="text-gradient">Caffeinated</span> and start ...
        </h3>
      ...
      <div className="card info-card">
        ...
        <p>
          ...
          coffee with 200 mg of caffeine, 5 hours, later, you&apos;ll have about
